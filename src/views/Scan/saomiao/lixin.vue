  ...
  <div>
    <div class="centrifugeImg">
      ...
      >
        <el-carousel-item v-for="(item,index) in centrifugeList" :key="index">
          ...
          <img class="test" :class="{'test-hover':index===carouselIndex}" src="@/assets/img/activeCen.png" />
        </el-carousel-item>
      </el-carousel>
    </div>
    ...
    <el-dialog :visible.sync="dialogSample" width="60%">
      <div class="dialogSample">
        ...
        >
          ...
          <el-table-column prop="sampleName" label="样本名称" class="DataTable">
            <template slot-scope="scope">{{ scope.row.date }}</template>
          </el-table-column>
          <el-table-column prop="projectName" label="项目名称" class="DataTable"></el-table-column>
        </el-table>
      </div>
      <span slot="footer" class="dialog-footer">
    ...
    <el-dialog title="订单详情" :visible.sync="dialogOrder" width="50%" center>
      <div class="dialogOrder">
        ...
        >
          <el-table-column type="index" width="70" label="序号" class="DataTable"></el-table-column>
          <el-table-column prop="orderName" label="名称" class="DataTable"></el-table-column>
